            ...
            <div class="col-md-8 offset-md-2">
              <form method="POST" action="">
                <div class="input-group">
                  <input type="search" class="form-control form-control-lg" placeholder="Masukkan Kode Barcode" id="input_scanner" name="input_scanner" autofocus>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-3">
                    <h5>Total <strong id="totalHargaKeseluruhan">Rp <?= number_format($total_harga, 0, ',', '.'); ?></strong></h5>
                  </div>
        ...
        <div class="modal-body">
          ...
          <form id="formBayar" action="transaksi.php" method="POST">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="jumlahUang" name="jumlah_uang" placeholder="Masukkan jumlah uang">
            </div>
